...
DEFAULT_METRICS_FILENAME = "metrics_v2.json"
...
def parse_args():
    parser = build_training_parser(
        description="Treina o modelo v2 de detecção de phishing.",
...
def main():
    ...
    # treina o modelo base para feature importance
    base_model.fit(X_train, y_train)

    # modelo calibrado para probabilidades
